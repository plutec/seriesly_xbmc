...
class APISLY(object):
    ...
    Return:
        Objeto APISLY
    """
    def __init__(self, username=None, password=None, force=None):
    ...
    """
    def get_serie_info(self, id, mediaType):
        """
        ...
        url = 'http://series.ly/series/serie-%s' % id
    ...
    def get_most_valuated(self, mediaType):
        ...
        lis = soup.findAll('li', {'class':'mediaThumbsList'})
        to_ret = list()
        for li in lis:
            to_insert = dict()
            to_insert['name'] = li['title']#.find('div', {'class':'thumbTitleName'}).text
