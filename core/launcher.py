...
def select_channel(action, channel_name, params, url, category):
    logger.debug("ACTION %s" % repr(action))
    if action == 'main':
        channelselector.mainlist(params, url, category)
    elif action == 'logout':
        channelselector.logout(params, url, category)
    elif action == 'search':
        channelselector.search(params, url, category)
    elif action == 'details':
        channelselector.film_details(params, url, category)
    elif action == 'my_series':
        logger.info("ENTRA EN MIS SERIES")
        channelselector.my_series(params, url, category)
    elif action == 'serie_seasons':
        logger.info("ENTRA EN TEMPORADAS")
        channelselector.series_seasons(params, url, category)
    elif action == 'chapters':
        logger.info("ENTRA EN CAPITULOS")
        channelselector.series_chapters(params, url, category)
    elif action == 'links':
        channelselector.show_links(params, url, category)
    elif action == 'play_video':
        logger.info("ENTRA EN PLAYVIDEO")
        channelselector.play_video(params, url, category)
    elif action == 'my_movies':
        logger.info("ENTRA EN MY_MOVIES")
        channelselector.my_movies(params, url, category)
    elif action == 'change_status':
        logger.info("ENTRA EN CHANGE_STATUS")
        channelselector.change_status(params, url, category)
    elif action == 'update_plugin':
        logger.info("ENTRA EN UPDATE PLUGIN")
        updater.launch()
    elif action == 'view_video':
        logger.info("ENTRA EN VIEW VIDEO")
        channelselector.view_video(params, url, category)
    elif action == 'configuration':
        logger.info("ENTRA EN CONFIGURATION")
        config.launch()
    elif action == 'report':
        logger.info("Entra en REPORT")
        channelselector.report_link(params, url, category)
    elif action == 'most_valuated_series':
        logger.info("Entra en MOST_VALUATED_SERIES")
        channelselector.most_valuated_series(params, url, category)
    elif action == 'most_valuated_movies':
        logger.info("Entra en MOST_VALUATED_MOVIES")
        channelselector.most_valuated_movies(params, url, category)
