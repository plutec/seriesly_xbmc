# -*- coding: iso-8859-1 -*-
#------------------------------------------------------------
# pelisalacarta - XBMC Plugin (Thanks!)
# Zip Tools
# http://blog.tvalacarta.info/plugin-xbmc/pelisalacarta/
# Modified by plutec to include pwd in zip file
#------------------------------------------------------------
...
class ziptools:
    ...
    def extract(self, file, dir, pwd=None):
        ...
        for name in zf.namelist():
            ...
            if not name.endswith('/'):
                ...
                try:
                    ...
                    logger.info("name=%s" % name)
                    os.makedirs( path ) #Crea el directorio necesario
                except:
                    pass
                ...
                try:
                    ...
                    if pwd:
                        outfile.write(zf.read(name, pwd=pwd))
                    else:
